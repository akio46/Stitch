...
RocketChat.settings.add 'Accounts_EmailVerification', true, { type: 'boolean', group: 'Accounts', public: true, section: 'Registration' }
...
RocketChat.settings.add 'Accounts_AllowUsernameChange', false, { type: 'boolean', group: 'Accounts', section: 'General', public: true }
...
RocketChat.settings.add 'API_Analytics_Mixpanel', '{"Mixpanel": {"token":  "0a10c7fe0224af6ef3b873524a142dca", "people": true}}', { type: 'string',multiline: true, group: 'API', public: true }
...
RocketChat.settings.add 'From_Email', 'no-reply@teamstitch.com', { type: 'string', group: 'SMTP' }
...
RocketChat.settings.add 'Stripe_PublishableKey', 'pk_test_3zlgt70nb3kiyycH0ww1FEFR', { type: 'string', group: 'Stripe', public: true }
RocketChat.settings.add 'Stripe_SecretKey', 'sk_test_crMpixyoLxkjslaO6pZBfn9J', { type: 'string', group: 'Stripe' }
