RocketChat.Notifications = new class
	...
	notifyUser: (userId, eventName, args...) ->
		...
		notifyOffline(userId, args[1].payload.sender._id)
...
notifyOffline = (receiverId, senderId) ->
	...
	if receiver.statusConnection is 'offline'
		...
		RocketChat.models.Mentions.createWithUserId receiverId
		...
		Meteor.setTimeout (->
			...
			if mention?
				...
				Mandrill.messages.sendTemplate
					'template_name': 'meteor-message-waiting-offline-email'
					'template_content': [ {} ]
					'message':
