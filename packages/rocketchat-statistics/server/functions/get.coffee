...
#	statistics.totalRooms = RocketChat.models.Rooms.findByOrg(orgId).count()
#	statistics.totalChannels = RocketChat.models.Rooms.findByType('c', orgId).count()
#	statistics.totalPrivateGroups = RocketChat.models.Rooms.findByType('p', orgId).count()
#	statistics.totalDirect = RocketChat.models.Rooms.findByType('d', orgId).count()
