...
Meteor.startup(function () {
  if (RocketChat.settings.get('API_Analytics_Mixpanel')) {
    analytics.initialize(JSON.parse(RocketChat.settings.get('API_Analytics_Mixpanel').trim()));
  } else {
    console.log("Missing analyticsSettings in API_Analytics_Mixpanel");
  }
